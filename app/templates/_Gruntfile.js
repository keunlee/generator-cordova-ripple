...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            js: {
                ...
                tasks: ['newer:jshint:all', 'cordova-prepare'],
                options: {
            ...
            compass: {
                ...
                tasks: ['compass:server', 'autoprefixer', 'sync:platform', 'cordova-prepare']
            },
            gruntfile: {
                files: ['Gruntfile.js']
            },
            ...
            livereload: {
                options: {
                    ...
                    middleware: function (connect, options, middlewares) {
                            ...
                            res.write = function (string, encoding) {
                                ...
                                if (string && isHtml(string)) {
                                    try {
                                        ...
                                        body = snap(body, config.cordova_script_snippet);
                                        restore();
                        ...
                        middlewares.unshift(connect.static(config.app));
    ...
    grunt.registerTask('cordova-prepare', 'copy files to cordova platforms', function () {
        exec('cordova prepare', function (error) {
            if (error !== null) {
                throw error;
            }
        });
    ...
    grunt.registerTask('serve', 'Compile then connect a web server', function () {
        grunt.task.run([
            'clean:server',
            'wiredep',
            'concurrent:server',
